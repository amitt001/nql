...
stopwords['english'] = ['a', 'about', 'above', 'after', 'again', 'against', 'am', 'an', 'and', 'any', 'are', "aren't", 'as', 'attribute','attributes','at', 'be', 'because', 'been', 'before', 'being', 'between', 'both', 'but', 'by', "can't", 'cannot', 'column', 'columns','could', "couldn't", 'did', "didn't", 'do', 'does', "doesn't", 'doing', "don't" , 'dont','down', 'during', 'each', 'elements', 'element','few', 'for', 'further', 'had', "hadn't", 'has', "hasn't", 'have', "haven't", 'having', 'he', "he'd", "he'll", "he's", 'her', 'here', "here's", 'hers', 'herself', 'him', 'himself', 'his', 'how', "how's", 'i', "i'd", "i'll", "i'm", "i've", 'if', 'in', 'is', "isn't", 'it', "it's", 'its', 'itself', "let's", 'me', 'most', "mustn't", 'my', 'myself', 'named','no', 'nor', 'not', 'of', 'off', 'on', 'once', 'only', 'or', 'other', 'ought', 'our', 'ours', 'ourselves', 'out', 'over', 'own', 'same', "shan't", 'she', "she'd", "she'll", "she's", 'should', "shouldn't", 'so', 'some', 'such' ,'table', 'than', 'that', "that's", 'the', 'their', 'theirs', 'them', 'themselves', 'then', 'there', "there's", 'these', 'they', "they'd", "they'll", "they're", "they've", 'this', 'those', 'through', 'to', 'too', 'type','under', 'until', 'up', 'very', 'was', "wasn't", 'we', "we'd", "we'll", "we're", "we've", 'were', "weren't", 'what', "what's", 'when', "when's", "where's", 'which', 'while', 'who', "who's", 'whom', 'why', "why's", 'with', "won't", 'would', "wouldn't", 'you', "you'd", "you'll", "you're", "you've", 'your', 'yours', 'yourself', 'yourselves']
